                            ...
                            <div>
                                <div class="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                                    <div class="md:w-64">
                                        ...
                                        <input type="name" tabindex="0" class="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="fullName" placeholder="John" onChange={e => setFullName(e.target.value)} />
                                    </div>
                                    <div class="md:w-64 md:ml-12 md:mt-0 mt-4">
                                        <label class="text-sm leading-none text-gray-800" id="ssn">SSN</label>
                                        <input type="password" tabindex="0" class="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="ssn" placeholder="Doe" onChange={e => setSsn(e.target.value)} />
                                    </div>
                                </div>
                            ...
                            <div>
                                <div class="md:flex items-center lg:ml-24 lg:mt-0 mt-4">
                                    ...
                                    <div class="md:w-64 md:ml-12 md:mt-0 mt-4">
                                        ...
                                        <input type="password" tabindex="0" class="w-full p-3 mt-3 bg-gray-100 border rounded border-gray-200 focus:outline-none focus:border-gray-600 text-sm font-medium leading-none text-gray-800" aria-labelledby="password" placeholder="KeySecure01!" onChange={e => setPassword(e.target.value)} />
                                    </div>
                                </div>
                            </div>
                        </div>
