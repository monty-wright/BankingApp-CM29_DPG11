                          ...
                          <ul className="f-m-m">
                              ...
                              <li className="text-gray-700 pt-8">
                                  ...
                                  {product ? (
                                      <div>
                                          <ul className="my-3">
                                              <li className="text-sm text-indigo-500 py-2 px-6"><a href="/createAccout" className="text-black hover:text-blue-800 visited:text-black">Create</a></li>
                                              <li className="text-sm text-indigo-500 py-2 px-6"><a href="/accountDetails" className="text-black hover:text-blue-800 visited:text-black">List</a></li>
                                          </ul>
                                      </div>
                                  ) : (
                                      ""
              ...
              <div className="justify-between container px-6 h-16 flex items-center lg:items-stretch mx-auto">
                  <div className="flex items-center">
                      ...
                      <ul className="pr-32 xl:flex hidden items-center h-full">
                          <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-indigo-700 tracking-normal"><a href="/" className="text-black hover:text-blue-800 visited:text-black no-underline">Dashboard</a></li>
                          <li className="hover:text-indigo-700 cursor-pointer h-full flex items-center text-sm text-gry-800 mx-10 tracking-normal relative">
                              {product ? (
                                  <ul className="bg-white shadow rounded py-1 w-32 left-0 mt-16 -ml-4 absolute  top-0">
                                      <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-gray-100 px-3 font-normal"><a href="/createAccount" className="text-black hover:text-blue-800 visited:text-black no-underline">Create</a></li>
                                      <li className="cursor-pointer text-gray-600 text-sm leading-3 tracking-normal py-3 hover:bg-gray-100 px-3 font-normal"><a href="/accountDetails" className="text-black hover:text-blue-800 visited:text-black no-underline">List</a></li>
                                  </ul>
                              ) : (
                                  ""
                              )}
